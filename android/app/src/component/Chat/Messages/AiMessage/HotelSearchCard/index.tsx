      ...
      <View style={HotelCardStyle.Hotelrow}>
        ...
        <View style={HotelCardStyle.topSection}>
          ...
          <View style={HotelCardStyle.rightContent}>
            <Text style={mainStyle.font.h2}>{hotel?.name}</Text>
            <Text style={mainStyle.font.size10}>
              {/* <MaterialDesignIcons
                name="map-marker"
                
                style={[mainStyle.font.size10, mainStyle.black50]}
            ...
            <Text style={[mainStyle.font.size10, mainStyle.blackText]}>
              {hotel?.rooms?.[0]?.name?.split(' ').slice(0, 3).join(' ')} •{' '}
              {guestText}
            </Text>

            <Text style={[mainStyle.font.size10]}>{board}</Text>

            <Text style={[mainStyle.black50, mainStyle.font.size10]}>
        ...
        <View style={HotelCardStyle.BottomSection}>
          ...
          >
            <Text style={mainStyle.whiteText}>
