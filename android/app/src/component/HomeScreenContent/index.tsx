  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.tabSection}>
        ...
        {/* Switch Button */}
        <TouchableOpacity
          style={[styles.switchContainer, switchOn && styles.switchActive]}
          onPress={() => setSwitchOn(!switchOn)}
        >
          <Text style={styles.switchText}>Plan with Mylz AI</Text>
          <View style={[styles.switchCircle, switchOn ? styles.circleRight : styles.circleLeft]} />
        </TouchableOpacity>
      </View>
